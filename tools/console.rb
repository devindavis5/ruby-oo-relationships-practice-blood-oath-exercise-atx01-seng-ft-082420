...
b1 = BloodOath.new(c1, f1, '2020-01-02')
b2 = BloodOath.new(c3, f1, '1999-10-01')
b3 = BloodOath.new(c2, f1, '2010-11-13')
b4 = BloodOath.new(c2, f1, '1994-09-24')
b5 = BloodOath.new(c3, f3, '2012-09-23')
b6 = BloodOath.new(c1, f3, '2018-03-08')
b7 = BloodOath.new(c1, f4, '2019-03-30')
